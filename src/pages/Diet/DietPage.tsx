...
},
{
...

 {
  ...
  steps: [
    ...
    "Dans un grand bol, mÃ©lange : lâ€™ail hachÃ©, lâ€™origan, le paprika, la poudre dâ€™oignon, les flocons de piment, le sel et le poivre. Ajoute le jus de citron, puis mÃ©lange. Incorpore les laniÃ¨res de poulet et mÃ©lange bien pour les enrober. Laisse mariner au minimum 15 minutes (idÃ©alement 30 minutes).",
    "PrÃ©parer la sauce",
    "Dans un bol, mÃ©lange : le yaourt Ã©crÃ©mÃ©, la sriracha, lâ€™ail Ã©mincÃ©, le persil, le sel et le poivre. Ajoute un peu de jus de citron selon ton goÃ»t. MÃ©lange jusqu'Ã  obtenir une sauce homogÃ¨ne. RÃ©serve au frais.",
...
},
{
  ...
  steps: [
    ...
    "PrÃ©parer la sauce",
    "Dans un bol, mÃ©lange : le yaourt grec, le concentrÃ© de tomate, lâ€™ail hachÃ©, le gingembre, le garam masala, le paprika, le curry, le sel et le poivre.",
...

 {
  ...
  ingredients: [
    ...
    "Une pincÃ©e de flocons de piment ou de paprika",
  ],
  steps: [
    "  PrÃ©parer lâ€™avocat",
...
},
{
...

 {
  ...
  title: "Overnight oats protÃ©inÃ©s",
  flavor: "sucre",
  prepTime: "5 Ã  7 min",
  servings: "1 pers",
...
},
{
  ...
  ingredients: [
    ...
    "4 cuillÃ¨res Ã  soupe de chocolat en poudre ou de cacao en poudre ou 50 g de chocolat noir Ã  pÃ¢tisser (70 Ã  85% de cacao)",
    "1 cuillÃ¨re Ã  soupe de levure chimique",
  ],
  steps: [
...
export const healthyRecipes: Recipe[] = [
{
  ...
  steps: [
    ...
    "PrÃ©chauffe le four Ã  200Â°C. Ã‰pluche la patate douce et coupe-la en dÃ©s. DÃ©pose-la sur une plaque, ajoute la moitiÃ© de lâ€™huile dâ€™olive, le paprika, la poudre dâ€™ail, un peu de sel et de poivre. MÃ©lange et enfourne pour 25 Ã  30 minutes, jusqu'Ã  ce quâ€™elle soit tendre et dorÃ©e.",
    "Cuire le poulet",
...
},
{
  ...
  steps: [
    ...
    "Dans un petit bol, mÃ©lange lâ€™huile dâ€™olive, le vinaigre (ou le jus de citron), le sel et le poivre.",
    "Assembler le bowl",
...
const FLAVOR_OPTIONS: Array<{ value: "sucre" | "sale"; label: string }> = [
  { value: "sale", label: "SalÃ©" },
  { value: "sucre", label: "SucrÃ©" },
]
const FLAVOR_PLACEHOLDER = "SÃ©lectionner un type"
const PLAN_DAY_PLACEHOLDER = "SÃ©lectionner un jour"
const PLAN_SLOT_PLACEHOLDER = "SÃ©lectionner un moment"
  ...
  <>
    ...
    <main className="diet-gymgirl-page">
      ...
      <section className="diet-blog">
        ...
        {isCreateOpen ? (
          <div className="diet-recipe-modal" role="dialog" aria-label="CrÃ©er une recette">
                    ...
                    <div className="diet-recipe-form__row">
                      <label>
                        ...
                        <select value={editFlavor} onChange={(event) => setEditFlavor(event.target.value as "sucre" | "sale")}>
                          ...
                          <option value="sucre">SucrÃ©</option>
                        </select>
                      </label>
                      <label>
                        PrÃ©paration
                ...
                <header className="diet-recipe-modal__header">
                  <div>
                    ...
                    <div className="diet-plan-modal__meta">
                      <span>{selectedRecipe.flavor === "sucre" ? "SucrÃ©" : "SalÃ©"}</span>
