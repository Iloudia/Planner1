...
export const massRecipes: Recipe[] = [
{
  ...
  toppings: [
    "Fruits rouges",
    "Beurre de cacahuÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¨te",
    "Skyr ou fromage blanc",
    "Chocolat noir fondu",
    "Sirop d'ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©rable (lÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©ger)",
  ],
  tips: [
...
},
{
...

 {
  ...
  steps: [
    ...
    "Verse la pate dans le moule.",
    "Enfourne 50 minutes.",
    "Le banana bread est pret quand un couteau ressort presque propre.",
    "7. Refroidir",
...
},
{
  ...
  steps: [
    ...
    "Fais 6 petits tas sur la plaque.",
    "Aplatis legerement pour former des biscuits fins.",
    "Les biscuits fins deviennent plus croustillants.",
    "4. Cuisson",
    "Enfourne 10 a 12 minutes.",
    "Les biscuits doivent devenir legerement dores et croustillants.",
    "5. Ajouter la couche chocolat",
    "Fais fondre le chocolat noir au micro-ondes ou bain-marie.",
    "Etale une couche de chocolat fondu sur chaque biscuit.",
    "6. Ajouter les noisettes",
    "Concasse legerement les noisettes.",
    "Saupoudre-les sur le chocolat.",
    "7. Refroidir",
    "Laisse refroidir 10 minutes pour que le chocolat durcisse.",
...
},
{
...

 {
  ...
  steps: [
    ...
    "2. Repos",
    "Laisse reposer 5 minutes.",
    "Melange de nouveau pour eviter que les graines collent.",
    "Mets au refrigerateur au moins 4 heures ou toute la nuit.",
    "Les graines vont absorber le lait et creer une texture pudding.",
    "3. Ajouter les framboises",
    "Ecrase la moitie des framboises pour creer un coulis naturel.",
    "Ajoute-les sur le pudding.",
    "4. Ajouter les toppings",
    "Ajoute le reste des framboises entieres.",
    "Ajoute noix de coco rapee ou granola.",
...
},
{
  ...
  steps: [
    ...
    "Verse le miel.",
    "Ajoute le jus de citron vert.",
    "Melange legerement.",
    "Cela cree un petit sirop naturel tres parfume.",
    "4. Ajouter la noix de coco",
    "Ajoute les copeaux de noix de coco.",
    "Melange legerement.",
    "5. Finition",
    "Ajoute quelques feuilles de menthe si tu veux.",
    "Serre bien frais.",
